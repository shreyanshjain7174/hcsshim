# Copilot Code Review — Global Rules
...
- **[BLOCKER]** — Correctness, safety, resource leak, or API stability issue.
- **[ISSUE]** — Likely bug or deviation from established patterns.
